...
describe('EditListingComponent', () => {
  ...
  const authServiceMock = jasmine.createSpyObj('AuthService', ['isAdmin', 'getDefaultAvatar']);
  ...
  authServiceMock.getDefaultAvatar.and.returnValue('https://google.com/ipfs/guess');
